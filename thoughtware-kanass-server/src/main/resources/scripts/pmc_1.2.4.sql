...
UPDATE pcs_mec_message_template SET msg_type_id = 'KANASS_MESSAGETYPE_JOINPROJECT', msg_send_type_id = 'site', title = '成为项目新成员', content = '你成为项目新成员
><font color=comment>项目:     </font>  ${projectName}
><font color=comment>邀请人: </font>  ${createUser.nickname}
', link = '/projectDetail/${projectId}/workTable', bgroup = 'kanass', link_params = NULL WHERE id = '51c487985a82';
...
UPDATE pcs_mec_message_template SET msg_type_id = 'KANASS_MESSAGETYPE_JOINPROSET', msg_send_type_id = 'site', title = '加入项目集', content = '加入项目集', link = '/projectSetdetail/${projectSetId}/projectSetProjectList', bgroup = 'kanass', link_params = NULL WHERE id = 'c78eb1817307';