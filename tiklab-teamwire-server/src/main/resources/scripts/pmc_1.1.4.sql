...
UPDATE "pcs_todo_task_template" SET "title" = '待办事项', "link" = 'index/projectDetail/${projectId}/work/${workItemId}', "bgroup" = 'teamwire', "content" = '<div style="display: flex; align-items: center; font-size: 14px; justify-content: space-between;">
    ...
    </div>', "link" = 'projectDetail/${projectId}/work/${workItemId}', "bgroup" = 'teamwire', "abstract_content" = '${master}添加事项' WHERE "id" = 'f621925c6e63';
UPDATE "pcs_op_log_template" SET "title" = '项目添加日志', "content" = '<div style="display: flex; align-items: center; font-size: 14px; justify-content: space-between;gap: 20px;">
    ...
    </div>', "link" = '/index/${projectType}/${projectId}/survey', "bgroup" = 'teamwire', "abstract_content" = '${master}添加项目' WHERE "id" = 'c5613dbc2726';
UPDATE "pcs_op_log_template" SET "title" = '事项负责人修改', "content" = '<div style="display: flex; align-items: center; font-size: 14px; justify-content: space-between; gap: 20px;">
        ...
        <div style="font-size: 13px; flex-shrink: 0;"> ${receiveTime} </div>
    </div>', "link" = 'projectDetail/${projectId}/work/${workItemId}', "bgroup" = 'teamwire', "abstract_content" = '${master.nickname}更换负责人' WHERE "id" = '4c4d9114ddc0';
UPDATE "pcs_op_log_template" SET "title" = '事项状态修改', "content" = '<div style="display: flex; align-items: center; font-size: 14px; justify-content: space-between; gap: 20px;">
        ...
        <div style="font-size: 13px; flex-shrink: 0;"> ${receiveTime} </div>
    </div>', "link" = 'index/projectDetail/${projectId}/work/${workItemId}', "bgroup" = 'teamwire', "abstract_content" = '${master.nickname}更新了状态' WHERE "id" = '31d39e6f981a';