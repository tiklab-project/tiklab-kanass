package io.tiklab.teamwire.project.stage.controller;
...
import io.tiklab.teamwire.project.stage.service.StageWorkItemService;
...
public class StageWorkItemController {
    ...
    public Result<Void> deleteStageWorkItemCondition(@RequestBody @NotNull StageWorkItem stageWorkItem){
        stageWorkItemService.deleteStageWorkItem(stageWorkItem);
