package io.tiklab.teamwire.home.statistic.controller;
...
import io.tiklab.teamwire.home.statistic.service.WorkItemStatService;
...
public class WorkItemStatController {
    ...
    @Autowired
    private WorkItemStatService reporterService;
    ...
    public Result<List<WorkItemStatistic>> statWorkItemByStatus(){
        List<WorkItemStatistic> list = reporterService.statWorkItemByStatus();
    ...
    public Result<List<WorkItemStatistic>> statSprintWorkItemByStatus(@NotNull String sprintId){
        List<WorkItemStatistic> list = reporterService.statSprintWorkItemByStatus(sprintId);
    ...
    public Result<List<WorkItemBusStatusStat>> statWorkItemByBusStatus(){
        List<WorkItemBusStatusStat> list = reporterService.statWorkItemByBusStatus();
    ...
    public Result<List<ProjectWorkItemStat>> statManageSprint(@NotNull String projectId){
        List<Sprint> list = reporterService.statManageSprint(projectId);
    ...
    public Result<List<ProjectWorkItemStat>> statProjectManageSprint(@NotNull String masterId,@NotNull String projectId){
        List<Sprint> list = reporterService.statProjectManageSprint(masterId,projectId);
    ...
    public Result<List<ProjectWorkItemStat>> statSprintProcessWorkItem(@NotNull String masterId,@NotNull String sprintId){
        List<WorkItem> list = reporterService.statSprintProcessWorkItem(masterId,sprintId);
    ...
    public Result<List<WorkItemBusStatusStat>> statSprintWorkItemByBusStatus(@NotNull String sprintId){
        List<WorkItemBusStatusStat> list = reporterService.statSprintWorkItemByBusStatus(sprintId);
    ...
    public Result<List<WorkItem>> statWorkItemProcess(){
        List<WorkItem> list = reporterService.statWorkItemProcess();
    ...
    public Result<List<WorkItem>> statProgramSetWorkItemProcess(String[] ids){
        List<WorkItem> list = reporterService.statProgramSetWorkItemProcess(ids);
    ...
    public Result<List<WorkItem>> statProjectWorkItemProcess(String projectId){
        List<WorkItem> list = reporterService.statProjectWorkItemProcess(projectId);
    ...
    public Result<Pagination<WorkItem>> statWorkItemOverdue(@RequestBody @Valid @NotNull WorkItemQuery workItemQuery){
        Pagination<WorkItem> pagination = reporterService.statWorkItemOverdue(workItemQuery);
