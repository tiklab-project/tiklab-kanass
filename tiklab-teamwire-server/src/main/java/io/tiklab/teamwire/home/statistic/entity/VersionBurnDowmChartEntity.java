package io.tiklab.teamwire.home.statistic.entity;
 ...
 */
@Entity
@Table(name="pmc_version_burndowm")
public class VersionBurnDowmChartEntity {
    @Id
    ...
    //项目迭代id
    @Column(name = "version_id",length = 32,notNull = true)
