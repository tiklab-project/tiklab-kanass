...
INSERT INTO pcs_prc_function (id, name, code, parent_function_id, sort, type) VALUES ('work_type_update', '编辑事项类型', 'work_type_update', 'work_type',1, '1');
INSERT INTO pcs_prc_function (id, name, code, parent_function_id, sort, type) VALUES ('work_type_update_flow', '流程配置', 'work_type_update_flow', 'work_type',2, '1');
INSERT INTO pcs_prc_function (id, name, code, parent_function_id, sort, type) VALUES ('work_type_update_form', '表单配置', 'work_type_update_form', 'work_type',3, '1');
INSERT INTO pcs_prc_function (id, name, code, parent_function_id, sort, type) VALUES ('work_type_update_permissions', '权限配置', 'work_type_update_permissions', 'work_type',4, '1');
INSERT INTO pcs_prc_function (id, name, code, parent_function_id, sort, type) VALUES ('work_type_delete', '删除事项类型', 'work_type_delete', 'work_type',5, '1');
...
-- -- INSERT INTO pcs_prc_function (id, name, code, parent_function_id, sort, type) VALUES ('product_plan_create_work', '创建事项', 'product_plan_create_work', 'product_plan', 4, '2');
-- -- INSERT INTO pcs_prc_function (id, name, code, parent_function_id, sort, type) VALUES ('product_plan_delete_work', '删除事项', 'product_plan_delete_work', 'product_plan', 5, '2');
...
-- -- INSERT INTO pcs_prc_function (id, name, code, parent_function_id, sort, type) VALUES ('product_plan_update_work', '编辑事项', 'product_plan_update_work', 'product_plan', 7, '2');
--
-- -- 产品 需求
-- INSERT INTO pcs_prc_function_group (id, name, code, function_ids, sort, type)
