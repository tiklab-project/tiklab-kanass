...
INSERT INTO pcs_prc_function_group (id, name, code, function_ids, sort, type)
VALUES ('ka_setting', '设置', 'ka_setting', 'domain_user,domain_role,domain_message', 9, 2);
...
--角色
INSERT INTO pcs_prc_function (id, name, code, parent_function_id, sort, type) VALUES ('domain_role', '角色', 'domain_role', NULL, 2, '2');
...
--消息
INSERT INTO pcs_prc_function (id, name, code, parent_function_id, sort, type) VALUES ('domain_message', '消息', 'domain_message', NULL, 3, '2');
