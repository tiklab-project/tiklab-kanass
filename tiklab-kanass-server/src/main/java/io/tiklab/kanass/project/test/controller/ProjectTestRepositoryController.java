...
import io.tiklab.kanass.project.test.service.ProjectTestRepositoryService;
...
public class ProjectTestRepositoryController {
    ...
    public Result<String> createProjectTestRepository(@RequestBody @NotNull @Valid ProjectTestRepository projectTestRepository){
    ...
    //@ApiParam(name = "projectTestRepository",desc = "迭代DTO",required = true)
    public Result<Void> updateProjectTestRepository(@RequestBody @NotNull @Valid ProjectTestRepository projectTestRepository){
