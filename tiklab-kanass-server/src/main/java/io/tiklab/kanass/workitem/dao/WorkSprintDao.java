...
public class WorkSprintDao {
    ...
    */
    ...
    public List<Map<String, String>> findSprintWorkItemNum(String ids) {
        String sql = "select pws.sprint_id, pws.work_item_id, pwi.work_status_code  from pmc_work_sprint pws left join pmc_work_item pwi on pwi.id = pws.work_item_id where pwi.work_status_code is not null and pws.sprint_id in "+ ids;
